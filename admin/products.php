<?php
/**
 * Products Admin - with CSRF protection
 */
...
// Handle product deletion with CSRF protection
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= (int)$product['stock_quantity'] ?> ks</td>
                            <td>
                            ...
                            <td class="table-actions">
                                <a href="/admin/product-edit.php?id=<?= (int)$product['id'] ?>" class="btn btn-sm">Upravit</a>
                                <a href="/admin/products.php?delete=<?= (int)$product['id'] ?>&csrf_token=<?= urlencode(csrf_token()) ?>"
